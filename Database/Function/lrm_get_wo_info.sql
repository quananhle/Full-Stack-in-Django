...
AS $function$
	BEGIN
		RETURN QUERY	
			...
			CASE WHEN d.customer_pn IS NULL THEN 'N/A'::VARCHAR ELSE d.customer_pn END, a.production_version , a.serial_number AS sn_from , b.serial_number AS sn_to
			...
			LEFT JOIN mfg_materialmaster d ON a.skuno = d.model_id LIMIT 1;
	END;
$function$
;
